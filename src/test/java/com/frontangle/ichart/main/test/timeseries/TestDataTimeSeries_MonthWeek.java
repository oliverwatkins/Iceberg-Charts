...
//		createSomeRandomData();
		...
		XYDataSeries series2 = new XYDataSeries(new UIPointSquare(Color.MAGENTA), new Line(Color.MAGENTA), "Something Magenta");
	...
	public static void main(String[] args) throws Exception {
		ChartTester t = new TestDataTimeSeries_MonthWeek();
