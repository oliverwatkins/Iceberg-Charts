...
import com.frontangle.ichart.chart.datapoint.DataPointMultiBar.MultiBarMode;
...
public class TestDataBar_MultiBar_SideBySide extends ChartTester {
	...
	public Chart getChart() {
		...
		XYChart chart = new XYChart("Side by Side", "Year", "Percent Taxed",
				xySeriesList);
