...
public class TestDataGrids_7_TimeSeries extends ChartTester {
	...
	public Chart getChart() throws ParseException {
		...
		NumericalInterval t1 = new NumericalInterval(6, 50.0, new GridLine(
				Color.GRAY, false, 1));
		NumericalInterval t2 = new NumericalInterval(3, 10.0, new GridLine(
		...
		TimeInterval timeInt1 = new TimeInterval(7, TimeInterval.Type.YEAR,
				new GridLine(Color.GRAY, false, 6), yearFormat);
		TimeInterval timeInt2 = new TimeInterval(2, TimeInterval.Type.MONTH,
				new GridLine(Color.GRAY, false, 3), monthFormat);
		TimeInterval timeInt3 = new TimeInterval(2, TimeInterval.Type.NONE,
				new GridLine(Color.GRAY, false, 1));

		XAxis xAxis = new XAxis(new TimeSeriesAxisScaling(startDate, endDate,
				timeInt1, timeInt2, timeInt3), "Time Series"); // timeInt2,
																// timeInt3),
																// "Time Series");
