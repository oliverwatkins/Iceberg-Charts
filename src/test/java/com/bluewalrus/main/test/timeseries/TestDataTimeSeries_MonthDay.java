...
public class TestDataTimeSeries_MonthDay extends ChartTester {
	...
	public Chart getChart() throws ParseException {
		...
		XYDataSeries series = new XYDataSeries(
				new UIPointSquare(Color.BLUE, 4), new GridLine(Color.BLUE),
				"Something Blue");
		...
		TimeInterval timeInt1 = new TimeInterval(2, TimeInterval.Type.MONTH,
				new GridLine(Color.GRAY, false, 2), monthFormat);
		timeInt1.styling = new IntervalStyling(10, new GridLine(Color.BLACK,
				false, 2), new GridFill(Color.LIGHT_GRAY, Color.WHITE, false));

		TimeInterval timeInt2 = new TimeInterval(2, TimeInterval.Type.DAY,
				new GridLine(Color.GRAY, false, 1), dayFormat);
		timeInt2.styling = new IntervalStyling(2, new GridLine(Color.GRAY,
				false, 1), null);
