...
public class SimplePieChart_OLD extends JPanel {

//	enum Type {
//		STANDARD, SIMPLE_INDICATOR, GRADED_INDICATOR
//	}

	private PieChartType type = null; // the type of pie chart
	...
	public SimplePieChart_OLD(int percent) {

		type = PieChartType.SIMPLE_INDICATOR;
		this.percent = percent;
	}

	public SimplePieChart_OLD(ArrayList<Double> values, ArrayList<Color> colors) {

		type = PieChartType.STANDARD;

		this.values = values;
		this.colors = colors;
	}

	public SimplePieChart_OLD(int percent, ArrayList<Double> gradingValues,
			ArrayList<Color> gradingColors) {
	...
	protected void paintComponent(Graphics g) {
		...
		} else if (type == PieChartType.STANDARD) {
