 ...
 * 
 * 
 * This has not been implemented properly. It is a copy and paste from the NumericalAxisScalingY
 * 
 * 
 * @author Oliver Watkins
 *
 */
public class TimeSeriesAxisScalingY extends LinearNumericalAxisScaling {

    public TimeSeriesAxisScalingY() {
		super(Orientation.Y);
	}
    
	public TimeSeriesAxisScalingY(double min, double max) {
		super(min, max, Orientation.Y);
	}

	public TimeSeriesAxisScalingY(Double primaryIncrements,
	...
	public TimeSeriesAxisScalingY(Double minValue, Double maxValue,
