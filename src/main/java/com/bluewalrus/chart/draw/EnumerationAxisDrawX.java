...
public class EnumerationAxisDrawX extends EnumerationAxisDraw {
	...
	//
	// //to first increment
	// double toFirstInPixels =
	// getToFirstIntervalValueFromMinInPixels(interval.getIncrement(), factor);
	//
	// double fromLeft = getFromLeft(chart, toFirstInPixels, incrementInPixel,
	// i);
	//
	// XAxisDrawUtil.drawIntervalTick(interval, g, chart, fromLeft,
	// chart.xAxis);
	//
	// }
	//
	...
	// //to first increment
	// // double toFirstInPixels =
	// getToFirstIntervalValueFromMinInPixels(increment, factor);
	//
	//
	// String xLabel = "DO ME";
	//
	...
	//
	//
	// private double getFromLeft(Chart chart, double toFirstInPixels, double
	// incrementInPixel, int i) {
